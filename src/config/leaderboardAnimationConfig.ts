...
export const LEADERBOARD_ANIMATION_CONFIG: ILeaderboardAnimationConfig = {
  intermediate: {
    enabled: true,
    timerDurationSec: 3,
    containerDurationMs: 400,
    rowStaggerMs: 50,
    maxRowStaggerMs: 300,
    scoreAnimationDurationMs: 1000,
    rankMovementDurationMs: 1000,
    accuracyAnimationDurationMs: 400,
    highlightDurationMs: 700,
    previousScoreboardPhaseMs: 1000,
    countingPointsPhaseMs: 1200,
    reorderingPhaseMs: 1000,
    emojiRevealPhaseMs: 800,
    postAnimationCountdownSec: 3,
  },
  final: {
    enabled: true,
    introDurationMs: 800,
