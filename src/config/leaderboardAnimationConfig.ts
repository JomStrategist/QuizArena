...
export const LEADERBOARD_ANIMATION_CONFIG: ILeaderboardAnimationConfig = {
  intermediate: {
    ...
    rowStaggerMs: 70,
    maxRowStaggerMs: 400,
    scoreAnimationDurationMs: 1600,
    rankMovementDurationMs: 1600,
    accuracyAnimationDurationMs: 500,
    highlightDurationMs: 900,
    previousScoreboardPhaseMs: 2000,
    countingPointsPhaseMs: 2000,
    reorderingPhaseMs: 2000,
    emojiRevealPhaseMs: 1500,
