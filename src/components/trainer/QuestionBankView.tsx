  ...
  return (
    <div className="space-y-6 font-sans text-slate-800 pb-12">
      ...
      {loading ? (
        ...
        /* Card View Listing matching reference design */
        <div className="space-y-3">
          {paginatedQuestions.map((q, index) => {
            ...
            return (
              <div
                key={q._id}
                className={`bg-white p-4.5 rounded-2xl border border-slate-200 border-l-4 ${getCardBorderColor(
                  index
                )} shadow-xs hover:shadow-md transition-all space-y-3 relative`}
              >
                {/* Header Row */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-start space-x-3">
                    ...
                    {/* Code Badge */}
                    <span className="px-2 py-0.5 text-xs font-black text-blue-700 bg-blue-50 rounded-lg border border-blue-100 shrink-0">
                      {questionCode}
                    </span>
                ...
                {/* 4 Options Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 pl-9">
                  {q.options?.map((opt, optIdx) => (
                    <div
                      key={optIdx}
                      className={`p-2 rounded-xl text-xs truncate border ${
                        optIdx === q.correctOptionIndex
                          ? 'bg-emerald-50 border-emerald-300 text-emerald-950 font-bold'
                          : 'bg-slate-50 border-slate-200/80 text-slate-600'
                      }`}
                    >
                      <span className="font-black mr-1 text-slate-400">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2 border-t border-slate-100 pl-9 text-xs">
                  ...
                  <div className="flex items-center space-x-1.5 shrink-0 justify-end">
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold rounded-lg transition flex items-center space-x-1"
                    >
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 text-xs font-bold rounded-lg transition flex items-center space-x-1"
                    >
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 text-xs font-bold rounded-lg transition flex items-center space-x-1"
                    >
